...
// Adapté du bloc Sidebar de shadcn/ui (ui.shadcn.com/docs/components/sidebar)
// sur les primitives déjà utilisées dans ce projet (@base-ui/react) plutôt que
// Radix : useRender remplace Slot pour le polymorphisme (asChild), Sheet/
// Tooltip/Separator réutilisent les wrappers Base UI existants.
      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>Accès aux patients, consultations et au compte.</SheetDescription>
          </SheetHeader>
...
function SidebarMenuBadge({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "pointer-events-none absolute right-1 top-1.5 flex h-5 min-w-5 items-center justify-center rounded-md px-1 text-xs font-medium text-sidebar-foreground tabular-nums select-none",
